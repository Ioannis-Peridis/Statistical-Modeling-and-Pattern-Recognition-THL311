...
train_images_reshaped = train_images.reshape(-1,width,height,num_of_channels)# reshape to mum_train_images X height X width X channels, where channels = 1
...
# This is the sum of the history for accuracy
