...
title('Normalized Data + Dimension Direciton');
hold off;
...
%This is the total variance from the sum of eigenvalues
totalVar = sum(sum(S));
%This is the largest eigenvalue , it is at S(1,1)
...
%These are the variables needed in order to calculate the percent of the total variance in the 1st K PC.
eigVals = sum(S);
