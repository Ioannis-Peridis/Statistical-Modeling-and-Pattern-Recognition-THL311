...
%  Use different color/symbol for each class
 ...
 IRIS1red = meas_reduced(iris_labels==0,:);%Samples of Class 0
 IRIS2red = meas_reduced(iris_labels==1,:);%Samples of Class 1 
 IRIS3red = meas_reduced(iris_labels==2,:);%Samples of Class 2
